                  ...
                  {showUserTypeChoice ? (
                    ...
                    <>
                      <button
                        ...
                        className='flex items-center justify-center rounded-md border w-full border-transparent bg-white px-4 py-3 text-base font-medium text-blue-700 shadow-sm hover:bg-blue-50 sm:px-8'
                      >
                        Sign up
                      </button>
                      <Link
                        to='/login'
                        className=' flex items-center justify-center bg-blue-500 px-4 py-3 rounded-md  font-medium text-white hover:bg-blue-600'
                      >
                        Log In
                      </Link>
                    </>
